<template>
    ...
    <!-- MISSION -->
    <article>
        <h1 data-toggle="collapse" data-target="#collapse__mission">Oikos’s MISSION in a convulsed world: <br>
            “change the system, not the climate”</h1>
    ...
    <article>
        ...
        <div id="collapse__short-version" class="collapse">
            ...
            <p> The accumulation of transformative power made possible by industrialization has come with an
                ...
                geological epoch, the Anthropocene, in which humanity no longer just <em class="text-serif">inhabits</em>,
                but is in charge of her habitat. The very shape of the planet
                is
    ...
    <article>
        ...
        <div id="collapse__historial-context" class="collapse">
            ...
            <p> Once the problem becomes apparent, however, so does the “solution.” Progress is intrinsically
                ...
                “arrow of history” does not fly indefinitely: arrows land on a target: a <em class="text-serif">telos</em>.
            </p>
    ...
    <article>
        ...
        <div id="collapse__focus-goals" class="collapse">
            <p> An arresting realization is slowly dawning on industrial modernity. Technological ingenuity alone
                ...
                “With
                no credible pathway to 1.5°C in place,” we are set for climate disaster, that “<em class="text-serif">
            ...
            <p> Indeed, by virtue of its coordination capacity, the decarbonizing impact of institutional innovation
                should dwarf that of material technologies —for a far lower cost: <br> <em class="color-rojo text-serif">
                    “Next to the most sumptuous scientific tool of physics, the
